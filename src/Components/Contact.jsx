...
const Contact = () => {
    ...
    return (
        <div id="contact" className={`w-full px-[12%] py-10 scroll-m-20 font-Outfit ${mode}`}>
            ...
            <form action="" className="max-w-2xl mx-auto flex flex-col gap-4 items-center">
                <div className="grid grid-cols-2 gap-4 w-full">
                    <input 
                        ...
                        className={`flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md ${mode}`}
                    />
                    <input 
                        type="email" 
